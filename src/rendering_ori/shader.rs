...
pub fn create_program(gl: &gl::Gl, shaders: [gl::types::GLuint; 2]) -> Result<gl::types::GLuint, String> {
...
pub fn use_program(gl: &gl::Gl, program: gl::types::GLuint) {
    unsafe {
        gl.UseProgram(program);
    }
}

pub fn get_uniform_location(gl: &gl::Gl, program: gl::types::GLuint, name: &str) -> Result<gl::types::GLint, String> {
...
pub fn shader_from_source(gl: &gl::Gl, source: &CStr, kind: gl::types::GLuint) -> Result<gl::types::GLuint, String> {
